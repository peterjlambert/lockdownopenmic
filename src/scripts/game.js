...
const items = [
  ...
  "Hosts mess up the order",
  "Preamble lasts 30 seconds or more",
  "Tuning",
  "A duet",
  "A borrowed song",
  "A dedication",
  "A soundcheck",
  "3 or more instruments are played",
  "Someone is too loud",
  "Someone is too quiet",
  "Someone's singing harmonies",
  "Rob's battery is low",
  "Sunglasses on screen",
  "Someone performs two originals",
  "Jim and Gary Bromance",
  "Someone says 'Pal' or 'Mate'",
  "A reference that has to be explained to Alex",
  "A reference that has to be explained to our American friends",
  "A reference to the 90s",
  "A song from a film",
  "A song from a musical",
  "A location change",
  "A national day is mentioned",
