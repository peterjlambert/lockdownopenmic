...
<span class="bingo__stamp">
  <svg class="bingo__stampSvg" aria-hidden="true" viewBox="0 0 1022 1073" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const selectedItems = shuffleArray(items).slice(0, selectedItemsMax);
...
if (bingoWrapper) {
  console.log(buildBingoCard(selectedItems));
